<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="showpatients.aspx.vb" Inherits="doct1.showpatients" MasterPageFile="admin_home.Master" %>
...
<br /><br />
    <asp:DataGrid ID="showpatient" runat ="server" AutoGenerateColumns ="False" CellPadding="4" ForeColor="#333333" GridLines="None" >

          <AlternatingItemStyle BackColor="White" ForeColor="#284775" />

          <Columns >
              <asp:BoundColumn HeaderText ="Patient Name" DataField ="name"></asp:BoundColumn>
              <asp:BoundColumn HeaderText ="E-Mail" DataField ="emailid"></asp:BoundColumn>
              <asp:BoundColumn HeaderText ="Mobile No." DataField ="contactno"></asp:BoundColumn>
             ...
             <asp:BoundColumn HeaderText ="Gender" DataField ="gender"></asp:BoundColumn>
              ...
              <asp:BoundColumn HeaderText ="Registration Date" DataField ="registration_date"></asp:BoundColumn>
